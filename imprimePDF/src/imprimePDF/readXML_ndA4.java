...
public class readXML_ndA4 {
	...
	//	String _file_xml="R:\\conector\\data\\20525378358\\03_xmls_con_firma\\20525378358-01-F001-0000001.xml";
		...
		System.out.println("direccion...    "+_file_xml);
	...
	*/
			...
			if  (Cabecera.get_descripcion_documento().equals("DebitNote")) {
				...
				for (int _linea = 0; _linea < _total_linea; _linea++) {
					...
					NodeList nList_LineExtensionAmount01 = doc.getElementsByTagName("cbc:LineExtensionAmount");
					Node nNode_LineExtensionAmount = nList_LineExtensionAmount01.item(_linea);
					Detalle[_lineaArreglo].set_subtotal((Double.parseDouble(nNode_LineExtensionAmount.getTextContent())));
					
					
					NodeList nList_PriceAmount01 = doc.getElementsByTagName("cac:Price");
					Node nNode_PriceAmount = nList_PriceAmount01.item(_linea);
					...
					NodeList nList_TaxableAmount01 = doc.getElementsByTagName("cbc:TaxAmount");
					Node nNode_TaxableAmount = nList_TaxableAmount01.item(_linea+4);
						try {
